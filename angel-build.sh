...
# Download official local manifest from place-guide
echo -e "${CYAN}Downloading official local manifest...${RESET}"
curl -L https://raw.githubusercontent.com/The-Angel-Place-Sapphire/place-guide/refs/heads/main/local_manifest.xml \
    -o .repo/local_manifests/sapphire.xml || error_exit "Failed to download local manifest"
print_header "Local manifest downloaded"
...
# Sync repo
echo -e "${CYAN}Syncing all repositories...${RESET}"
